 ...
 */
export class PromoteTestsToTestcaseStep {
    name = 'PromoteTestsToTestcaseStep';
    fileSystem;
    ...
    async execute(context) {
        ...
        const promotedTestFilePath = path.join(path.dirname(existingTestFilePath), path.basename(context.validatedTestFilePath));
    ...
    async findTestFile(testcasePath) {
