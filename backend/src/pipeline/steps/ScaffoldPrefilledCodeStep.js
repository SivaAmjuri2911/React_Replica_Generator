 ...
 * package.json/package-lock.json "name". SyncPrefilledSeedDataStep later copies
 * only leading seed-data arrays from solution when the starter already had them.
 */
/**
